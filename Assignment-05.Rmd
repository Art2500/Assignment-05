...
rename(CountryDeathTibble, new_name==Country, Newname==Date, NewName==Total_Deaths)
filter(CountryDeathTibble, CNTRYNAME==France| CNTRYNAME==Germany| CNTRYNAME==Italy)
